...
namespace Bufet.Controllers
{
    public class ZamowieniasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Zamowienie,Data,Cena,IdKanapki,IdUzytkownik")] Zamowienia zamowienia)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Zamowienie,Data,Cena,IdKanapki,IdUzytkownik")] Zamowienia zamowienia)
        {
            if (id != zamowienia.Id)
            {
                return NotFound();
